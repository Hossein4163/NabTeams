    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <DashboardLink
          ...
          title="✅ مدیریت تسک تیم"
          description="پس از فعال‌سازی توسط ادمین، تسک‌های تیم را ثبت کنید، وضعیت آن‌ها را به‌روزرسانی کنید و از پیشنهادهای هوش مصنوعی بهره ببرید."
        />
        {isAdmin && (
          <DashboardLink
